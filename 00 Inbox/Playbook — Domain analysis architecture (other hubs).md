---
title: "Playbook — Domain analysis architecture (other hubs)"
type: project
...
## 2. Priority order for *this* vault
...
| **5. Proceduri / contencios** | Energy contencios note exists; generalise | Administrative cascade + deadlines; bridges from every domain’s *ultra vires* / tariff challenges |
| **6. Drept civil** | Foundation layer | Keep code-index driven; synthesis around obligations/property/security interests that other hubs cite — avoid re-cataloguing the Civil Code |

---

## 3. Domain-specific adaptations

| Domain | “Market segments” analogue | Conflict theme to name early |
|---|---|---|
| Tax | Titlu / tax type + procedure stage (assessment → appeal) | Annual rate volatility; draft ≠ law (2027 concept) |
| Companies | Lifecycle stages (form → operate → reorganise → exit) | Special law vs Civil Code; L845 legacy |
| Commercial | Activity gates (permit, conduct, exit) | Silence-is-consent / RIA vs sectoral lex specialis |
| Procurement | Procedure types (open, restricted, utilities, concessions) | Sectoral vs classical; remedy deadlines |
| Procedure | Claim types + instance ladder | Contencios vs civil vs fiscal appeal routes |

---

## 4. DoD checklist (copy per hub)

1. Primary + secondary acts with currency flags  
2. Segment / stage table (empty cells allowed if labelled)  
3. Actor map  
4. Licence / permit / filing list  
5. Links to adjacent hubs (energy ↔ companies for unbundling, etc.)  
6. Support / social / crisis overlays where relevant  
7. Explicit **gaps** and incomplete texts  

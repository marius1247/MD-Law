...
Reorganise synthesis around **inter-law communication** and **market segmentation**. Plan: [[Roadmap — Energy analysis architecture]]. Spine: [[Energetică — architecture map]]. Steps 1–5 ✅ (electricity, gas, petroleum + coal gap, thermal / CHP + geothermal stub). **Next: biofuels / hydrogen (Step 6).**

...
Reorganise synthesis around **inter-law communication** and **market segmentation**. Plan: [[Roadmap — Energy analysis architecture]]. Spine: [[Energetică — architecture map]]. Steps 1–2 ✅ — electricity hub + [[Energetică — segmente piață electricitate (notă)|segment briefs]] + L164 actor concepts. **Next: gas hub (Step 3).**

...
## Done — Foundations
- Vault scaffold, `.obsidian` config, [[Conventions|conventions]], templates
...
The vault now has a reasoning layer on top of the texts. `20 Domains` holds one synthesis per domain; `30 Concepts` holds 21 atomic notes; four new authority profiles.

- **Energy** — [[Energetică — synthesis]] + act companions for [[Legea 174-2017 — energetica (notă)|L174/2017]], [[Legea 108-2016 — gazele naturale (notă)|L108/2016]], [[Legea 10-2016 — surse regenerabile (notă)|L10/2016]] + 7 concepts
- **Companies & governance** — [[Societăți & guvernanță — synthesis]] + 6 concepts + [[ASP]], [[CNPF]]
- **Tax & accounting** — [[Fiscalitate — synthesis]] + [[Contabilitate & raportare financiară — synthesis]] + 5 concepts + [[SFS]]
- **Commercial** — [[Drept comercial — synthesis]] + 3 concepts + [[Consiliul Concurenței]]

## Diagnosed — the ingestion ceiling
The `— text` truncation is **not a bug that can be fixed by re-running the download**. Automated fetch from legis.md stops at **~96,000 characters**, mid-sentence, silently; legis.md has no per-chapter endpoint and its viewer is client-rendered. Confirmed by re-fetching L107/2016 and getting the identical cut. **Large acts require a manual browser download.** Full write-up: [[Status ingestie — Energetica]] · [[Conventions]].
...
- [[Energetică — synthesis]] §6 rewritten; [[MOC — Energetică]] and [[Status ingestie — Energetica]] restructured
...
> Marius supplied full legis.md downloads into `99 Attachments/source-legis/`. L174/2017, L92/2014, L100/2017, HANRE 283 annex, HANRE 420 annex, HANRE 112/113/168 are now **complete**. New L164-era acts ingested: HANRE 311/2026 (connection), 626/2023 + 261/2026 (transport tariffs), 383/2026 (market rules amend), 328/2025 + 310/2026 (gas network code amends). Keystone statutes for companies, tax, commercial, civil, procedure and sectoral procurement are now in the vault with analysis companions.
...
Reorganise synthesis around **inter-law communication** and **market segmentation**. Plan: [[Roadmap — Energy analysis architecture]]. Spine: [[Energetică — architecture map]]. Steps 1–2 ✅ closed (electricity hub, segment briefs, L164 actor/retail/FCEE concepts, [[Energetică — prosumer vs consumator activ (notă)|prosumer boundary]]). **Next: gas hub (Step 3).**
...
## Blocked / deferred
- ~~Bulk act ingestion~~ — largely unblocked by manual `99 Attachments/source-legis/` dumps
...
| File | Why it matters |
|---|---|
| **New entrepreneurship law** (project 345/MDED/2025) | Repeals **L845/1992** entirely, 2-year transition → [[Drept comercial — synthesis]] |
| **Legea nr. 86/2026** → in force **1 Jan 2027** | Raises accounting size thresholds sharply; many entities drop a category → [[Contabilitate & raportare financiară — synthesis]] |
...
| **SA remuneration policy** amendments to L1134/1997 | EU governance alignment → [[Societăți & guvernanță — synthesis]] |
...
- Keep `99 Attachments/source-legis/` as the raw-dump inbox; do not edit ingested `— text` files except to update consolidations

...
Reorganise synthesis around **inter-law communication** and **market segmentation**. Plan: [[Roadmap — Energy analysis architecture]]. Spine: [[Energetică — architecture map]]. Step 1 ✅ — electricity hub rewritten: [[MOC — Piața de energie electrică]]. Next: electricity deep fill (Step 2), then gas hub (Step 3).

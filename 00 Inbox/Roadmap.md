...
Reorganise synthesis around **inter-law communication** and **market segmentation**. Plan: [[Roadmap — Energy analysis architecture]]. Spine: [[Energetică — architecture map]]. Steps 1–3 ✅ (electricity + gas hubs). **Next: petroleum / coal (Step 4).**

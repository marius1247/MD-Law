...
**Related:** [[Audit ingestie — 2026-07-26]] · [[Status ingestie — Energetica]] · [[Convenții vault]] · [[MOC — Energetică]]
...
| Layer | Files | Role |
|---|---:|---|
| `10 Acte normative` — `(text)` | 66 | Romanian legal text, article-anchored |
| `10 Acte normative` — `(notă)` | 35 | English analysis companions |
| `20 Domenii` — synthesis | 5 | Cross-act reasoning |
| `30 Concepte` | 21 | Atomic institution/term notes |
...
| **T4 — domain synthesis** | Cross-act reasoning, sector risk map | [[Energetică — sinteza sectorului]] |
...
|---|---|
| Vol I — Primary legislation | `10 Acte normative/Legi organice & ordinare/` + `Coduri/` |
| Vol II — Grid access & supply | `10 Acte normative/Acte ANRE & autorități/` (connection + supply HANRE) |
| Vol III — Tariff methodologies | `10 Acte normative/Acte ANRE & autorități/` + [[Energetică — metodologii tarifare (notă)]] |
...
For themes spanning multiple acts, use `20 Domenii/` with `type: domain-note`:
...
1. **Never edit `— text` substance** except for consolidation updates — [[Convenții vault]]

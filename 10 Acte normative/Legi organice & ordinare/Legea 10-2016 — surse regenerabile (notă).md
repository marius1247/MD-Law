...
**Raw text:** [[Legea 10-2016 — surse regenerabile (text)]] · **Hub:** [[MOC — Energetică]] · **Synthesis:** [[Energetică — sinteza sectorului]]

> [!warning] Text status
> Truncated at **Art. 34** ([[Status ingestie — Energetica]]). Later provisions — including parts of the guarantees-of-origin and reporting machinery — are not in the vault.
...
## How it connects
- Support price flows through the tariff system → [[Concept — Tarif reglementat]]

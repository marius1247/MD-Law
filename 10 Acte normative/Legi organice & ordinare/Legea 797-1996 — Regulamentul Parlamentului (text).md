...
> Analiză: [[Legea 797-1996 — Regulamentul Parlamentului (notă)]].
...
## (3
## 1
) În vederea promovării unor viziuni şi obiective comune, deputaţii independenţi şi/sau
...
k
## 1
) aprobă Regulamentul de organizare şi funcţionare a Secretariatului Parlamentului;

k
## 2
) aprobă planurile strategice de dezvoltare a Secretariatului Parlamentului;
...
j
## 1
) dispune de fondul Preşedintelui Parlamentului;
...
## (4
## 1
) Pentru a facilita procesul de consultare publică a proiectelor de acte legislative şi a
...
### Articolul 28.
## 1
. Subcomisia pentru exercitarea controlului
...
### Articolul 43.
## 1
. Prioritatea propunerilor opoziţiei parlamentare
la întocmirea ordinii de zi
...
### Articolul 49.
## 1
. Organizarea de către comisia permanentă
...
e
## 1
) rezultatele consultării publice a proiectului;
...
### Articolul 58.
## 1
. Avizarea de către Adunarea Populară
...
d
## 1
) accesul în incinta Parlamentului şi în încăperile în care se desfăşoară şedinţele în plen ale
...
d
## 2
) blocarea tribunelor, blocarea accesului în sala de şedinţe, blocarea sau limitarea accesului
...
## (2
## 1
)  Deputatul  este  obligat  să  se  conformeze  cerinţelor  preşedintelui  şedinţei  sau  deciziei

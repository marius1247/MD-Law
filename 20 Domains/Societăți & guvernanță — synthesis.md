---
title: "Societăți & guvernanță — synthesis"
type: domain-note
...
Beyond registration sit the **permits and authorisations** for particular activities, which are a different question entirely and are governed by the licensing framework. → [[Drept comercial — synthesis]]
...
→ [[Concept — Insolvabilitate]] · [[Drept comercial — synthesis]]
...
## 8. Open threads
- Ingest **Legea 135/2007** (SRL) and **Legea 1134/1997** (SA) — the two keystone acts; both are large enough to need manual, per-chapter ingestion ([[Conventions]])
...
- Write [[ASP]] and [[CNPF]] institutional profiles into `60 Authorities`
- Reporting duties bridge to [[Contabilitate & raportare financiară — synthesis]]

## Related
[[MOC — Societăți & Guvernanță corporativă]] · [[Drept comercial — synthesis]] · [[Fiscalitate — synthesis]] · [[Contabilitate & raportare financiară — synthesis]] · [[ASP]] · [[CNPF]]

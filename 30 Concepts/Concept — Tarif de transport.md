---
title: Concept — Tarif de transport
type: concept
domain: tarife
domeniu:
- tarife
...
## Structură și Fundamentare
Tariful se calculează în baza metodologiilor aprobate de ANRE, având la bază principiul acoperirii costurilor necesare și justificate:

$$\text{Venit Reglementat} = \text{OPEX} + \text{Depreciere} + (\text{BAR} \times \text{CMPC}) + \text{Consum Propriu Tehnologic}$$

Unde:
* **OPEX:** Costuri de operare și întreținere.
* **BAR:** [[Concept — Baza activelor reglementate]].

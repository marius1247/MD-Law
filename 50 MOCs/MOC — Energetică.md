...
**Law (Parliament)** → sets the framework, creates the regulator, defines licensing/tariff principles
**→ Government (HG)** → security-of-supply, construction, protection zones, strategy
**→ ANRE (HANRE)** → the acts that actually bind market participants: market rules, network codes, connection/supply regulations, tariff methodologies
**→ individual decisions** → licences, specific tariffs (not ingested — see scope note)
...
| [[Legea 174-2017 — energetica (text)]] | Framework law: sector organisation, [[ANRE]]'s status & independence, energy policy |
| **[[Legea 164-2025 — energia electrica (text)]]** | **Electricity — the law in force.** ✅ *full text (151 art., consolidated incl. LP101/2026)*. Transposes Dir. (EU) 2019/944, Reg. (EU) 2019/943, REMIT, CACM. Adds storage, aggregation, trading |
...
| [[Legea 45-2025 — garantiile avizelor de racordare si tolerante dezechilibre (text)\|Legea nr. 45/2025]] | Connection guarantees >200 kW + wind/PV imbalance deadbands + TSO national-interest CAPEX in tariff ✅ · [[Legea 45-2025 — garantiile avizelor de racordare si tolerante dezechilibre (notă)\|notă]] |
| [[Legea 88-2025 — utilitate publica LEA 400 kV Balti-Suceava (text)\|Legea nr. 88/2025]] | Bălți–Suceava 400 kV public-utility + special expropriation ✅ · [[Legea 88-2025 — utilitate publica LEA 400 kV Balti-Suceava (notă)\|notă]] |
| [[Legea 227-2025 — optimizarea actelor permisive (text)\|Legea nr. 227/2025]] | Permissive-acts omnibus — energy slices (L461/L92/L10/L108) ✅ · [[Legea 227-2025 — optimizarea actelor permisive (notă)\|notă]] |
...
- [[HG 86-2025 — Plan national integrat energie clima 2025-2030 (text)\|HG 86/2025]] — **approves PNIEC 2025–2030** ⚠️ *annex missing* · [[HG 86-2025 — Plan national integrat energie clima 2025-2030 (notă)\|notă]]
...
- [[HG 668-2022 — stocuri securitate gaze naturale (text)\|HG 668/2022]] — Energocom gas security stocks ✅ · live level **56.3 mcm** (HG 299/2026) · [[HG 668-2022 — stocuri securitate gaze naturale (notă)\|notă]]
- [[HG 364-2024 — modificare stocuri securitate gaze (text)]] — patches HG 668 (47.1 mcm) ✅ · [[HG 364-2024 — modificare stocuri securitate gaze (notă)|notă]]
...
- [[HG 1059-2023 — PSO securitate aprovizionare energie electrica (text)\|HG 1059/2023]] — Energocom electricity security PSO ✅ · period **to 31.12.2026** · [[HG 1059-2023 — PSO securitate aprovizionare energie electrica (notă)\|notă]]
- [[HG 156-2025 — modificare HG 1059-2023 PSO securitate EE (text)\|HG 156/2025]] — mid-extend to **31.12.2025** ✅ · [[HG 156-2025 — modificare HG 1059-2023 PSO securitate EE (notă)\|notă]]
- [[HG 801-2025 — modificare HG 1059-2023 PSO securitate EE (text)\|HG 801/2025]] — L164 remap + extend to **31.12.2026** ✅ · [[HG 801-2025 — modificare HG 1059-2023 PSO securitate EE (notă)\|notă]]
- [[HG 197-2025 — metodologie cogenerare inalta eficienta garantii origine (text)\|HG 197/2025]] — HE-CHP GO methodology + HG 297/2016 reference values ⚠️ *methodology annex missing* · [[HG 197-2025 — metodologie cogenerare inalta eficienta garantii origine (notă)\|notă]]
- [[HG 302-2025 — modificare HG 668-2022 stocuri securitate gaze (text)\|HG 302/2025]] — mid-step **50 mcm** by 1.10.2025 ✅ · [[HG 302-2025 — modificare HG 668-2022 stocuri securitate gaze (notă)\|notă]] · superseded on volume by HG 299 → **56.3 mcm**
- [[HG 852-2024 — zone protectie retele electrice (text)\|HG 852/2024]] — EE protection zones ✅ body · form annexes ⚠️ · [[HG 852-2024 — zone protectie retele electrice (notă)\|notă]]
- [[Legea 74-2024 — actiuni climatice (text)\|LP74/2024]] — climate / ETS / PNIEC duties (Ministry of Energy art. 9) ✅ · [[Legea 74-2024 — actiuni climatice (notă)\|notă]]
- [[HG 329-2025 — modificare HG 401-2021 cote capacitate regenerabile (text)\|HG 329/2025]] — net-billing quotas patch to HG 401 · **abrogated parent** by [[HG 599-2025 — limite cote capacitate regenerabile pana 2030 (notă)\|HG 599/2025]] · [[HG 329-2025 — modificare HG 401-2021 cote capacitate regenerabile (notă)\|notă]]
- [[HG 599-2025 — limite cote capacitate regenerabile pana 2030 (text)\|HG 599/2025]] — RES limits/quotas + net-billing ceilings to **2030** ⚠️ *annexes 1–2 missing* · [[HG 599-2025 — limite cote capacitate regenerabile pana 2030 (notă)\|notă]] · [[Concept — Facturare netă]]
- [[HG 517-2024 — Regulament constructie reconstructie centrale electrice (text)\|HG 517/2024]] — >20 MW plant authorisation ✅ · [[HG 517-2024 — Regulament constructie reconstructie centrale electrice (notă)\|notă]] · patched [[HG 596-2025 — infrastructura transport EE autorizare centrale echilibrare (notă)\|596/2025]]
- [[HG 596-2025 — infrastructura transport EE autorizare centrale echilibrare (text)\|HG 596/2025]] — Vulcănești corridor + L164 remap of plant authorisation + balancing winners on HG 26 PSO ✅ · [[HG 596-2025 — infrastructura transport EE autorizare centrale echilibrare (notă)\|notă]]
- [[HG 1060-2023 — organizare functionare CNED (text)\|HG 1060/2023]] — CNED statute/structure ⚠️ *annex 4 may truncate* · [[HG 1060-2023 — organizare functionare CNED (notă)\|notă]] · [[CNED]]
- [[HG 620-2025 — transmitere bunuri Fond eficienta energetica CNED (text)\|HG 620/2025]] — FEE asset transfer to beneficiaries ⚠️ *form annexes missing* · [[HG 620-2025 — transmitere bunuri Fond eficienta energetica CNED (notă)\|notă]]
...
**Amending laws**
- [[Legea 45-2025 — garantiile avizelor de racordare si tolerante dezechilibre (text)\|LP45/2025]] — amends L107 art. 47/88 + L10 art. 37(7) · [[Legea 45-2025 — garantiile avizelor de racordare si tolerante dezechilibre (notă)\|notă]]
- [[Legea 227-2025 — optimizarea actelor permisive (text)\|LP227/2025]] — permissive omnibus (energy: L461/L92/L10/L108) · [[Legea 227-2025 — optimizarea actelor permisive (notă)\|notă]] · patched [[Legea 317-2025 — modificare acte permisive (notă)\|LP317/2025]]
- [[Legea 317-2025 — modificare acte permisive (text)\|LP317/2025]] — L164 art. 20 interop + LP227 IF/tables · [[Legea 317-2025 — modificare acte permisive (notă)\|notă]]
...
- ~~[[HANRE 168-2019 — racordarea la retelele electrice (text)]]~~ — **abrogated** by HANRE 311/2026; historical · [[HANRE 168-2019 — racordarea la retelele electrice (notă)|notă]] · patched while live by [[HANRE 833-2023 — modificarea unor hotarari ANRE regenerabile (notă)|833/2023]] (net metering / eligible producers)
- [[HANRE 169-2019 — furnizarea energiei electrice (text)]] — electricity supply · [[HANRE 169-2019 — furnizarea energiei electrice (notă)|notă]] ⚠️ *truncated; L164 currency conflicts* · amended by [[HANRE 833-2023 — modificarea unor hotarari ANRE regenerabile (notă)|833/2023]]
...
- [[HANRE 422-2019 — calitate servicii transport distributie gaze (text)]] — gas QoS ⚠️ *decision-only; annex missing* · [[HANRE 422-2019 — calitate servicii transport distributie gaze (notă)|notă]] · patched by [[HANRE 328-2025 — modificare Codul retelelor de gaze naturale (notă)|328/2025]]
- [[HANRE 23-2017 — furnizarea energiei termice (text)]] — thermal supply ✅ *body* · form annexes ⚠️ · [[HANRE 23-2017 — furnizarea energiei termice (notă)|notă]]
- [[HANRE 443-2020 — Metodologie tarife distributie gaze (text)\|HANRE 443/2020]] — gas DSO methodology ⚠️ *decision-only; annex missing* · [[HANRE 443-2020 — Metodologie tarife distributie gaze (notă)\|notă]]
- [[HANRE 785-2025 — modificare Metodologie tarife distributie gaze 443-2020 (text)\|HANRE 785/2025]] — uniform gas DSO tariff / equalization (**IF 1.01.2026**) ✅ · [[HANRE 785-2025 — modificare Metodologie tarife distributie gaze 443-2020 (notă)\|notă]]
- [[HANRE 162-2026 — tarife uniforme distributie gaze (text)\|HANRE 162/2026]] — applied uniform rates + equalization table (**IF 1.04.2026**) ✅ · [[HANRE 162-2026 — tarife uniforme distributie gaze (notă)\|notă]]
...
- Gas TSO transport methodology HANRE **535/2019** — parent ❌ not ingested · amending act [[HANRE 329-2025 — modificare Metodologie tarife transport gaze (text)|329/2025]] ✅ · [[HANRE 329-2025 — modificare Metodologie tarife transport gaze (notă)|notă]]
- Gas supply / FUO prices [[HANRE 355-2021 — preturi reglementate furnizare gaze (text)|355/2021]] ⚠️ *decision-only* · [[HANRE 540-2024 — modificare Metodologie preturi furnizare gaze (text)|540/2024]] ✅ amend · [[HANRE 355-2021 — preturi reglementate furnizare gaze (notă)|355 notă]]

**Procurement (licence-holders) — currency fix**
- ~~[[HANRE 24-2017 — achizitii titulari de licenta (abrogata) (text)|HANRE 24/2017]]~~ — **abrogated** 06.08.2021 · [[HANRE 24-2017 — achizitii titulari de licenta (abrogata) (notă)|historic notă]]
- [[HANRE 305-2021 — abrogare HANRE 24-2017 achizitii titulari (text)|HANRE 305/2021]] — repeal · [[HANRE 305-2021 — abrogare HANRE 24-2017 achizitii titulari (notă)|notă]] → live [[Legea 74-2020 — achizitii sectoriale (notă)|L74/2020]] · [[MOC — Achiziții publice & Statul]]
...
6. Remaining tier-3 downloads: **535/2019** + **355/2021** methodology annexes, **537/2020** + **422/2019** QoS **annexes**, **443 methodology annex**, **HG 299/2026**, **HG 852 forms**, **HG 74/2025** annex, **L282/2023**. ✅ **2026-08-07i:** HG 668/852, LP74 climate, LP75/105 peripheral.
...
- Gas DSO tariff stack: [[HANRE 443-2020 — Metodologie tarife distributie gaze (notă)|443]] decision ✅ / **annex ❌** · [[HANRE 785-2025 — modificare Metodologie tarife distributie gaze 443-2020 (notă)|785]] · [[HANRE 162-2026 — tarife uniforme distributie gaze (notă)|162]] rates ✅ · QoS **422/2019 annex** + **537/2020 annex** still missing

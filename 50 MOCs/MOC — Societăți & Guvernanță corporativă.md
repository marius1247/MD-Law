---
title: "MOC — Societăți & Guvernanță corporativă"
type: moc
domeniu: societăți
...
| Layer | Act | Role |
|---|---|---|
| **General** | **Codul civil nr. 1107/2002**, Cartea I | Legal persons: capacity, organs, representation, reorganisation, liquidation |
| **Special — SRL** | **Legea nr. 135/2007** | Limited liability company. **No minimum share capital** |
| **Special — SA** | **Legea nr. 1134/1997** | Joint-stock company. **MDL 600,000** minimum (art. 38(2)) |
...
| | SRL | SA |
|---|---|---|
| Min. capital | **None** (the MDL 5,400 floor was abolished) | **MDL 600,000** |
| Ownership unit | *parte socială* — a participation | *acțiune* — a **security** |
| Mandatory organs | Meeting + administrator | Meeting + **board** + executive + audit |
| Regulator | [[ASP]] | [[ASP]] **+ [[CNPF]]** |
| Public offering | No | Yes |

> [!warning] Legacy SAs — check the capital figure first
> Law nr. 18/2020 gave existing SAs until **1 January 2024** to reach MDL 600,000. Non-compliant companies that have not resolved to reorganise or dissolve can be **dissolved by court order** on application by a shareholder or by [[CNPF]].

## EU alignment
**Legea nr. 1134/1997** has been amended to transpose **Directive (EU) 2017/1132** (codified company law) and **Directive 2007/36/EC** (shareholder rights). Directors' remuneration policy for persons holding positions of responsibility is a live legislative file. Expect continued movement — this is one of the more actively harmonised domains.

## Authorities
- **[[ASP]]** — State Register of Legal Entities. Registration is **constitutive**
- **[[CNPF]]** — securities market and SA supervision
...
| Act | Text | Analysis |
|---|---|---|
| [[Legea 135-2007 — SRL (text)\|Legea nr. 135/2007]] (SRL) | ✅ complete | [[Legea 135-2007 — SRL (notă)]] |
| [[Legea 1134-1997 — societati pe actiuni (text)\|Legea nr. 1134/1997]] (SA) | ✅ complete | [[Legea 1134-1997 — societati pe actiuni (notă)]] |

...
## Status *(2026-08-07)*
Foundations + **energy corpus largely complete** + **keystone texts ingested** for companies, tax, commercial, civil, procedure and sectoral procurement — each with an English analysis companion. Latest: HANRE 24/305 (procurement repeal), 656 (network-code Parts I–V), 833 (renewables omnibus), 329 (gas conditional-capacity tariffs). See [[Roadmap]] for remaining gaps (L131/2015, 423 consolidation, 535/537 parents, distribution/renewables tariff annexes, L164 currency audit).
